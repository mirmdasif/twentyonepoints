...
import { WaistComponent } from 'app/entities/waist/waist.component';
import { WaistService } from 'app/entities/waist/waist.service';
import { Waist } from 'app/shared/model/waist.model';

describe('Component Tests', () => {
    describe('Waist Management Component', () => {
        let comp: WaistComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WaistComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.waists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
